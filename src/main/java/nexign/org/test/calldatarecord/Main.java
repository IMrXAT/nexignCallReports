...
// считал строку - парсер ее распарсил done - информация о звонке доставляется в объект Callinfo done
// - объект Callinfo добавляется в очередь

// когда все строки файла прочитаны, нужно для каждого ключа из мапы перебрать все звонки и записать их информацию в таблицу